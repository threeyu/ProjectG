@set UNITY_HOME=F:\Program Files\Unity20200308f1c1\Unity
...
@set DLL_OUTPUT=..\..\UnityProject\Assets\Plugins\IFix\IFix.Core.dll
@set TOOL_KIT_PATH=..\..\UnityProject\IFixToolKit
